...
const SignUp = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const response = await fetch('http://votre_serveur/api/inscription.php', {
                method: 'POST',
                headers: {
                        ...
                        <div className="mx-auto max-w-xs">
                            <form onSubmit={handleSubmit}>
                                <input
                                    ...
                                    type="text" name="prenom" placeholder="Prénom" value={prenom} onChange={e => setPrenom(e.target.value)}/>
                                <input
                                    ...
                                    type="text" name="nom" placeholder="Nom" value={nom} onChange={e => setNom(e.target.value)}/>
                                <input
                                    className="w-full px-8 py-2 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-white"
                                    type="email" name="mail" placeholder="Email" value={email} onChange={e => setEmail(e.target.value)}/>
